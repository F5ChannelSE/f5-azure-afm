...
Deploy said VPN
~~~~~~~~~~~~~~~
1. Prep BIG-IP for VPN termination (Should be mostly completed after above steps)
...
2. Create RD1 for routed tunnel to exist inside of and disable strict isolation in RD0.
.. code-block:: shell
...
4. Create SNAT Pools for Both RD's.  RD0 will require the additional Azure NIC Ip outlined above. 
.. code-block:: shell
    create ltm snatpool RD1_SNATPOOL { members add { 172.31.x.5%1 } }
    create ltm snatpool RD0_SNATPOOL { members add { 10.0.3.x } }
5. Create LTM Pools for SSH traffic
.. code-block:: shell
...
9. Wrap up and delete resource group 
